...
% Jonathan Saenz - Cover Letter Template
% LaTeX Template

% define margin for a4paper size={8in, 11in}
\usepackage[letterpaper, left=0.5in,top=0.5in,right=0.5in,bottom=.5in]{geometry}
